...
TESSERA_FROST_UTM_VM_NAME=$TESSERA_FROST_UTM_VM_NAME
TESSERA_FROST_SWIFTPM_CACHE_ROOT=$TESSERA_FROST_SWIFTPM_CACHE_ROOT
TESSERA_FROST_SWIFTPM_CACHE_ARCHIVE=$TESSERA_FROST_SWIFTPM_CACHE_ARCHIVE
TESSERA_FROST_SWIFTPM_GUEST_CACHE_ROOT=$TESSERA_FROST_SWIFTPM_GUEST_CACHE_ROOT
TESSERA_FROST_SWIFTPM_GUEST_CACHE_NAME=$TESSERA_FROST_SWIFTPM_GUEST_CACHE_NAME
TESSERA_FROST_SWIFTPM_GUEST_CACHE_PATH=$TESSERA_FROST_SWIFTPM_GUEST_CACHE_PATH
