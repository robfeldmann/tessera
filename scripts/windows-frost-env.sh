...
export TESSERA_FROST_UTM_VM_NAME="${TESSERA_FROST_UTM_VM_NAME:-tessera-frost-import}"
export TESSERA_FROST_SWIFTPM_CACHE_ROOT="${TESSERA_FROST_SWIFTPM_CACHE_ROOT:-$TESSERA_FROST_WORK/swiftpm-cache}"
export TESSERA_FROST_SWIFTPM_CACHE_ARCHIVE="${TESSERA_FROST_SWIFTPM_CACHE_ARCHIVE:-$TESSERA_FROST_SWIFTPM_CACHE_ROOT/swiftpm-cache.tar.gz}"
export TESSERA_FROST_SWIFTPM_GUEST_CACHE_ROOT="${TESSERA_FROST_SWIFTPM_GUEST_CACHE_ROOT:-C:/Users/$TESSERA_FROST_USER/AppData/Local/tessera}"
export TESSERA_FROST_SWIFTPM_GUEST_CACHE_NAME="${TESSERA_FROST_SWIFTPM_GUEST_CACHE_NAME:-swiftpm-cache}"
export TESSERA_FROST_SWIFTPM_GUEST_CACHE_PATH="${TESSERA_FROST_SWIFTPM_GUEST_CACHE_PATH:-$TESSERA_FROST_SWIFTPM_GUEST_CACHE_ROOT/$TESSERA_FROST_SWIFTPM_GUEST_CACHE_NAME}"
