...
public struct TerminalRequirements: Equatable, Sendable {
  ...
  /// Whether the terminal must report pointer motion, not only button events.
  public var wantsMouseMotion: Bool
  ...
  public init(
    ...
    self.wantsMouseMotion = wantsMouseMotion
  ...
  public static func union(_ lhs: Self, _ rhs: Self) -> Self {
    Self(
      ...
      wantsMouseMotion: lhs.wantsMouseMotion || rhs.wantsMouseMotion,
